    ...
    def face_detect(self, frame):
        ...
        if len(rects)>0:
            ...
            if len(rectsf) >0:
                ...
                cv2.rectangle(face_frame, (shape[40][0], shape[40][1]), 
                        (shape[40][0],shape[40][1]), (0,255,0), 0)
                ...
                ROI3 = face_frame[shape[39][1]:shape[33][1], #nose
                       shape[31][0]:shape[35][0]]

                #ROI4=face_frame[shape[29][1]:shape[33][1], #nose
                 #      shape[0][0]:shape[0][0]]
